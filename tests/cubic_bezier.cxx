...
//      auto D1_label = plot.create_text(second_layer, label_style({.position = draw::centered_right_of}), plot_D1, "D₁");
      ...
      auto plot_line_P0Pgamm = plot.create_line_piece(second_layer, line_style, LineExtend::both, plot_P0, plot_P_gamma);

      // Draw line through P₁ and Pᵧ.
      auto plot_line_P1Pgamma = plot.create_line_piece(second_layer, line_style, LineExtend::both, plot_P1, plot_P_gamma);
